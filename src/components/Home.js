                ...
                <ul className="grid gap-4 grid-cols-1 md:gap-8">
                    ...
                    <ul className="grid gap-4 grid-cols-1 lg:grid-cols-3 md:gap-8">
                        <a href={tracks[0] && tracks[0].external_urls['spotify']} target="_blank">
                            <li className="visible -mb-44 lg:mb-0 p-3 bg-gradient-to-br from-cyan-200 to-cyan-400 h-40 rounded-2xl flex items-center text-3xl text-white transform hover:scale-105 transition duration-400 ease-in-out">
                        ...
                        <a href={tracks[1] && tracks[1].external_urls['spotify']} target="_blank">
                            <li className="invisible lg:visible p-3 bg-gradient-to-br from-primary-200 to-primary-400 h-40 rounded-2xl flex items-center text-3xl text-white transform hover:scale-105 transition duration-400 ease-in-out">
                                {tracks[1] && <img className="mr-4 rounded" width="130px" height="130px" src={tracks[1].album.images[1]['url']} alt={tracks[1].name}></img>}
                                {tracks[1] && (
                                    <div className="truncate w-4/5">
                                        <h3 className="">#2 Song</h3>
                        ...
                        <li className="invisible lg:visible p-3 bg-gradient-to-br from-yellow-200 to-yellow-400 h-40 rounded-2xl flex items-center text-3xl text-white transform hover:scale-105 transition duration-400 ease-in-out">
                            {tracks[2] && <img className="mr-4 rounded" width="130px" height="130px" src={tracks[2].album.images[1]['url']} alt={tracks[2].name}></img>}
                            {tracks[2] && (
                                <div className="truncate w-4/5">
                                    <h3 className="">#3 Song</h3>
                    ...
                    {groups.map(group => 
                        <div key={group.id}>
                            <Link to={`/app/group/${group.id}`}>
                                <li className="break-all overflow-hidden p-4 bg-gradient-to-br from-gray-600 to-gray-700 h-40 text-gray-300 transform hover:scale-105 transition duration-400 ease-in-out rounded-xl flex justify-center items-center text-center text-4xl font-light">
                                    <div className="flex flex-col">
                                        <h2>{group.name}</h2>
                                    </div>
                                </li>
